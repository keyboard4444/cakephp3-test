...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', '762ab9029f7fe1e10643da02e0c83f7425143fc1872ad1c9c147b2ba57c76aa7'),
    ],
    ...
    'Datasources' => [
        'default' => [
            ...
            'persistent' => false,
            'host' => env('APP_DEFAULT_HOST', 'localhost'),
            /**
             * CakePHP will use the default DB port based on the driver selected
             * MySQL on MAMP uses port 8889, MAMP users will want to uncomment
             * the following line and set the port accordingly
             */
            'port' => env('APP_DEFAULT_PORT', '3306'),
            'username' => env('APP_DEFAULT_USERNAME', 'username'),
            'password' => env('APP_DEFAULT_PASSWORD', 'password'),
            'database' => env('APP_DEFAULT_DATABASE', 'database'),
            'encoding' => 'utf8',
            'timezone' => 'UTC',
            'flags' => [],
            'cacheMetadata' => true,
        ...
        'test' => [
            ...
            'driver' => 'Cake\Database\Driver\Mysql',
            'persistent' => false,
            'host' => env('APP_DEFAULT_HOST_TEST', 'localhost'),
            'port' => env('APP_DEFAULT_PORT_TEST', '3306'),
            'username' => env('APP_DEFAULT_USERNAME_TEST', 'username'),
            'password' => env('APP_DEFAULT_PASSWORD_TEST', 'password'),
            'database' => env('APP_DEFAULT_DATABASE_TEST', 'database'),
            'encoding' => 'utf8',
            'timezone' => 'UTC',
            'cacheMetadata' => true,
            'quoteIdentifiers' => false,
